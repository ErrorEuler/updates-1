            ...
            <div class="w-full max-w-2xl form-wrapper py-4 lg:py-8">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        // In the form section, update the dual role section to ensure data is sent:
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                ...
                                <div class="flex items-center">
                                    <input
                                        ...
                                        name="has_dual_role"
                                        value="1"
                                        <?= (isset($_POST['has_dual_role']) && $_POST['has_dual_role'] == '1') ? 'checked' : '' ?>
                                ...
                                <div id="secondary-role-section" class="mt-3" style="display: none;">
                                    ...
                                    <div class="bg-white p-3 rounded border">
                                        ...
                                        <input type="hidden" id="secondary_role_id" name="secondary_role_id" value="<?= htmlspecialchars($_POST['secondary_role_id'] ?? '') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
